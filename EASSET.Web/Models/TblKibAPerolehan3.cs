...
public partial class TblKibAPerolehan3
{
    public string KibAPerolehan3Id { get; set; }
    ...
    public string PemberiHibah { get; set; }
    ...
    public string DokSumberPerolehanNomor { get; set; }

    public DateTime? DokSumberPerolehanTanggal { get; set; }
    ...
    public string DokSpNomor { get; set; }

    public DateTime? DokSpTanggal { get; set; }

    public string DokSpNama { get; set; }
}
