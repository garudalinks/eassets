using MyRepository = EASSET.Administration.Repositories.UserRoleRepository;
using MyRow = EASSET.Administration.UserRoleRow;

namespace EASSET.Administration.Endpoints;
